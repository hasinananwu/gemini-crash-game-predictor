...
export const mg = {
  ...
  localAnalysis: {
    ...
    default: 'Mety miovaova ny vokatra isan-karazany. Mitandrema rehefa miloka.',
    low_many: 'Latsaka be daholo. aleo maka  **Ambany (< 2.00x)**.',
    low_range: 'Aleo maka amin\'ny elanelana manodidina ny **{min}x - {max}x**.',
    medium_high: 'Mihoatra alaina **Ambony (>= 2.00x)**.',
    ...
    high_target: 'Afaka mikafiry mitady bebe kokoa **Tanjona Avo**.',
    high_safety: 'Aleo ihany maka milamina auto manodidina ny **3.00x**.'
  },
  gemini: {
...
Angona vinavina: {forecastData}`,
  ...
  guide: {
    ...
    qualityPhases: {
      ...
      catastrophic: { title: '🔴 LOZA', desc: 'Mamay be < 2.00x. aleo tsy miditra na maka Ambany.' },
    },
    multiplierTiers: {
      title: 'Ambaratongan’ny Cotes',
      catastrophic: 'Loza',
      bad: 'Ratsy',
      normal: 'Antony',
      good: 'Tsara',
    ...
    temporalCycles: {
      ...
      quarterly: { title: 'Fefakadiny:', desc: 'Ny 15 minitra voalohany amin’ny ora iray dia mazàna tsara kokoa noho ny 15 minitra farany.' },
    ...
    specialMinutes: {
      ...
      seven: { title: 'Minitra multiple ny 7:', desc: "Noheverina ho 'loza' ary tena mampidi-doza." },
      fiveThree: { title: 'Minitra multiple ny 5 na 3:', desc: "Mirona ho 'ratsy' na 'antony mankany amin’ny ratsy', izay manondro risika ambony kokoa." },
    },
  },
  settings: {
